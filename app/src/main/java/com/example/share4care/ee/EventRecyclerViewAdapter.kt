...
//    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        var like: HashMap<Any,Any> = hashMapOf()
        var dislike: HashMap<Any,Any> = hashMapOf()
        ...
        when(currentItem) {
            is Event -> {
                ...
                like = currentItem.like as HashMap<Any, Any>
                dislike = currentItem.dislike as HashMap<Any, Any>
                Log.d("likeeeee",like.toString())
            }
            is Service -> {
                title = currentItem.title
                description = currentItem.description
