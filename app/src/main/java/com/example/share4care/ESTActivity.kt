...
//        setContentView(R.layout.activity_est)
        ...
        var host = ""
        var image = ""
        var like = hashMapOf<Any,Any>()
        var dislike = hashMapOf<Any,Any>()
        ...
        estObj = when(intent.getSerializableExtra("eventObj")){
            is Event -> {
                ...
                host = obj.host
                image = obj.image
                like = obj.like as HashMap<Any,Any>
                dislike = obj.dislike as HashMap<Any,Any>
            }
            is Service -> {
        ...
        detailBundle = Bundle()
        detailBundle.putString("estType",estType)
