...
data class Event(
    ...
    constructor(title:String, host:String, category:String, description: String, date:String,
        ...
        (title, host, category, description, date, address, latitude, longtitude, contactNumber, contactEmail, imgUrl, 0, hashMapOf<String,String>(), hashMapOf<String,String>(), hashMapOf<String,String>(), arrayListOf())
}
