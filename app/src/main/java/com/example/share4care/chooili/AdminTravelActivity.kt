...
import com.example.share4care.databinding.ActivityAdminTravelBinding
...
class AdminTravelActivity : AppCompatActivity() {

    private lateinit var binding: ActivityAdminTravelBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAdminTravelBinding.inflate(layoutInflater)
                        ...
                        result.addOnSuccessListener {
                            ...
                            myDatabaseRef.child(key).setValue(newTravel)
                                .addOnSuccessListener {
                                    Toast.makeText(applicationContext, "Travel added ", Toast.LENGTH_LONG).show()
                                }
                                .addOnFailureListener {
